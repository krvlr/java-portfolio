...
public class RegistrationController {
    ...
    public ModelAndView registrationPost(@RequestParam("username") String username, @RequestParam("password") String password,
                                         @RequestParam("email") String email, @RequestParam("country") String country,
                                         @RequestParam("sex") String sex) {
        ModelAndView modelAndView = new ModelAndView();
        userService.registration(new User(username, password, email, country, sex, ""));
